...
int main() {
    ...
    cout << "The cave floor is cover with pressure plates! The pressure plates are 12 by 12";
    cout << "With the first pressure plate being marked with the letter A on the very left plate(1st plate) and ";
    cout << "the last plate G flat (12th plate)." << endl;
    cout << "The wall on the cave seemed to have parrots singing in the G Major scale." << endl;
    cout << endl;
    ...
    if (choice1 == 1) {
        ...
        cout << "This time there is 6 buttons with the first button being G and the last being F flat." << endl;
        cout << "Above the buttons wrote: the way is in the name of king Debac in an ancient amazonia language." << endl;
        cout << "What buttons should you press." << endl;
        cout << "Type 1 to press buttons 5, 6, 3, 2, 4. Or Type 2 to press buttons, 5, 2, 3, 6, 4." << endl;
        cin >> choice2;
        if (choice2 == 1){
            cout << "You have spelled Debac, the kings name." << endl;
            ...
            cout << "The gives out beneath you." << endl;
            cout << "Game Over" << endl;
        }
        else {
